...
unsigned int supported_playback_samplingrate[MAX_NUM_PLAYBACK_SR] = {8000,  16000, 32000,  44100,
...
audio_channel_mask_t supported_playback_channelmask[MAX_NUM_PLAYBACK_CM] = {
        AUDIO_CHANNEL_OUT_MONO, AUDIO_CHANNEL_OUT_STEREO};

// Supported direct Channel Mask
#define MAX_NUM_DIRECT_PLAYBACK_CM 3
audio_channel_mask_t supported_direct_playback_channelmask[MAX_NUM_DIRECT_PLAYBACK_CM] = {
        AUDIO_CHANNEL_OUT_5POINT1, AUDIO_CHANNEL_OUT_6POINT1, AUDIO_CHANNEL_OUT_7POINT1};

#define MAX_NUM_CAPTURE_CM 2
audio_channel_mask_t supported_capture_channelmask[MAX_NUM_CAPTURE_CM] = {
        AUDIO_CHANNEL_IN_STEREO, AUDIO_CHANNEL_IN_FRONT_BACK};

// Supported PCM Format
#define MAX_NUM_PLAYBACK_PF 3
audio_format_t supported_playback_pcmformat[MAX_NUM_PLAYBACK_PF] = {
        AUDIO_FORMAT_PCM_16_BIT, AUDIO_FORMAT_PCM_8_24_BIT, AUDIO_FORMAT_PCM_32_BIT};
...
#define ABOX_PRIV "calliope_priv"
#define ABOX_SLOG "calliope_slog"
#define ABOX_DUMP "/data/vendor/log/abox/"
#define ABOX_DUMP_LIMIT (3)
#define ABOX_GPR "gpr"
