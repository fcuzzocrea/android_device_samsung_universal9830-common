...
// Supported formats
int supported_usb_formats[] = {PCM_FORMAT_S32_LE, PCM_FORMAT_S24_3LE, PCM_FORMAT_S24_LE,
                               PCM_FORMAT_S16_LE, PCM_FORMAT_S8};
static const uint32_t MAX_NUM_USB_FORMAT = ARRAY_SIZE(supported_usb_formats);
char* const supported_usb_format_strs[] = {
        "AUDIO_FORMAT_PCM_32_BIT", "AUDIO_FORMAT_PCM_24_BIT_PACKED", "AUDIO_FORMAT_PCM_8_24_BIT",
...
unsigned int supported_usb_samplingrates[] = {384000, 192000, 96000, 48000,
                                              44100,  32000,  16000, 8000};

static const uint32_t MAX_NUM_USB_SR = ARRAY_SIZE(supported_usb_samplingrates);
char* const supported_usb_samplingrate_strs[] = {"384000", "192000", "96000", "48000",
                                                 "44100",  "32000",  "16000", "8000"};
...
#define DEFAULT_USB_MONO_CHANNEL 1                  // Mono
