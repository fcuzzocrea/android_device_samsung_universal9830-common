...
void Register_librecovery_updater_universal9830() {
  RegisterFunction("universal9830.verify_no_downgrade", VerifyNoDowngradeFn);
  RegisterFunction("universal9830.mark_header_bt", MarkHeaderBtFn);
  RegisterFunction("universal9830.write_data_bt", WriteDataBtFn);
}
